...
(optional) Know abit of coding, abit of python.<br></p>
...
<p>All meshes added in UPBGE have by default their /Editor: Outliner/Physics/Physics-Type: "Static",
...
Imported or created models can simply be parented to player, then deleting cube or hiding it to replace it with the desired player geometry.<br></p>
